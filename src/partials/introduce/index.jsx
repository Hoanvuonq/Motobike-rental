...
const Introduce = () => {
    ...
    return (
        <div className='all-center lg:!flex-row !flex-col gap-[2vw] py-[10vw]'>
            <img data-aos="fade-right" data-aos-delay="0" src={Moto} alt="Moto" className='lg:-[40vw] w-[90vw]' />
            <div className="introduce flex flex-col lg:gap-[1vw] gap-[4vw] lg:w-[40vw] w-[90vw] h-full">
