...
const listIMG = [
    { images: iconHighlights1, title: "Thủ tục nhanh, hợp đồng rõ ràng", content: "Với CCCD và BLS, bạn đã đủ điều kiện sử dụng dịch vụ cho thuê xe của chúng tôi." },
    { images: iconHighlights2, title: "Không ràng buộc giờ giấc", content: "Khác với các đơn vị khác, chúng tôi tính phí thuê xe theo 24h, giúp bạn tiết kiệm chi phí so với cách tính theo ngày từ sáng đến chiều." },
    { images: iconHighlights3, title: "Giao và trả xe tận nơi nhanh chóng", content: "Đội ngũ nhân viên kinh nghiệm của chúng tôi sẽ giao xe tận nơi trong nội thành Đà Nẵng chỉ sau 15-30 phút, không cần đặt cọc." },
]
        ...
        <div className='bg-highlights highlights all-center w-full h-[40vw]'>
            ...
            <div className="all-center absolute gap-[3vw] w-full">
                <div className="flex flex-col gap-[1vw] w-[30vw] h-full">
                    <div className="font-slogan text-mainColor">ĐIỂM NỔI BẬT</div>
                    <div className="font-title text-white uppercase">"Nâng tầm trải nghiệm lái Thân thiện và dễ dàng"</div>
