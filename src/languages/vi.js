const vi = {
    translation: {
        ...
        benefit: {
            ...
            title2: "Thuận tiện",
            title3: "Giá cả cạnh tranh",
            title4: "Tin cậy",
            title5: "Hỗ trợ 24/7",
            title6: "Bảo hiểm",
            content1: "Hàng trăm loại xe đa dạng ở nhiều địa điểm trên cả nước, phù hợp với mọi mục đích của bạn",
            content2: "Dễ dàng tìm kiếm, so sánh và đặt chiếc xe như ý với chỉ vài click chuột",
            content3: "Giá thuê được niêm yết công khai và rẻ hơn tới 10% so với giá truyền thống",
            content4: "Các xe đều có thời gian sử dụng dưới 3 năm và được bảo dưỡng thường xuyên",
        ...
        hightlight: {
            ...
            titleR2: "Không ràng buộc giờ giấc",
            titleR3: "Giao và trả xe tận nơi nhanh chóng",
            contentR1: "Với CCCD và BLX, bạn đã đủ điều kiện sử dụng dịch vụ cho thuê xe của chúng tôi.",
            contentR2: "Khác với các đơn vị khác, chúng tôi tính phí thuê xe theo 24h, giúp bạn tiết kiệm chi phí so với cách tính theo ngày từ sáng đến chiều.",
            contentR3: "Đội ngũ nhân viên kinh nghiệm của chúng tôi sẽ giao xe tận nơi trong nội thành Đà Nẵng chỉ sau 15-30 phút, không cần đặt cọc.",
        },
        introduce: {
